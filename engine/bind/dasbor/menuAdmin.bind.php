<ul class="sidebar-menu" style='margin-top:20px;'>
  ...
  <li class="dropdown">
    ...
    <ul class="dropdown-menu">
      ...
      <li><a class="nav-link" href="#!" v-on:click='bahanBakuAtc'>Bahan Baku</a></li>
  ...
  <li class="dropdown">
    ...
    <ul class="dropdown-menu">
      ...
      <li><a class="nav-link" href="#!" v-on:click='pengeluaranAtc'>Pengeluaran Resto</a></li>
    </ul>
  </li>
  ...
  <li><a class="nav-link" id='btnTentang' href='#!' v-on:click=''><i class="fas fa-heart"></i> <span>Tentang Aplikasi</span></a></li>
