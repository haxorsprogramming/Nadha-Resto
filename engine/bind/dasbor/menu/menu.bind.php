...
<thead>
  <tr>
  <th style="text-align: center;">Menu</th><th>Kategori / Satuan</th><th>Deks</th><th>Harga</th><th>Total Transaksi</th><th></th>
  </tr>
</thead>
<tbody>
<?php foreach($data['menu'] as $menu) : ?>
    <tr>
        ...
        <td>
            <a href='#!' class="btn btn-primary btn-icon icon-left btn-sm" @click='detailAtc'><i class='fas fa-info-circle'></i> Detail</a>
        </td>
    </tr>
<?php endforeach; ?>
</tbody>
